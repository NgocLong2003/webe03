! function (t, e) {
    ...
    function R(t, e, n) {
        if (function (e) {
            m(e.classList).forEach(function (t) {
                -1 === f(z).indexOf(t) && -1 === f(W).indexOf(t) && e.classList.remove(t)
            })
        }(t), e && e[n]) {
            if ("string" != typeof e[n] && !e[n].forEach) return N("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e[n]), '"'));
            st(t, e[n])
        }
    }
    var D = "SweetAlert2:",
        ...
        z = t(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "toast", "toast-shown", "toast-column", "show", "hide", "close", "title", "header", "content", "actions", "confirm", "cancel", "footer", "icon", "icon-content", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl", "timer-progress-bar"]),
    ...
    function nt(t) {
        var e = H();
        dt(e) && (e.style.transition = "width ".concat(t / 1e3, "s linear"), e.style.width = "0%")
    }
    ...
    function it(t) {
        Qe.isVisible() && ut !== t.target.value && Qe.resetValidationMessage(), ut = t.target.value
    }
    ...
    function at(t, e) {
        var n = L(),
            o = E(),
            i = T();
        e.showConfirmButton || e.showCancelButton || G(n), R(n, e.customClass, "actions"), gt(o, "confirm", e), gt(i, "cancel", e), e.buttonsStyling ? function (t, e, n) {
        ...
        }(o, i, e) : (ct([o, i], z.styled), o.style.backgroundColor = o.style.borderLeftColor = o.style.borderRightColor = "", i.style.backgroundColor = i.style.borderLeftColor = i.style.borderRightColor = ""), e.reverseButtons && o.parentNode.insertBefore(i, o)
    }
    var ut, st = function (t, e) {
        $(t, e, !0)
    },
        ct = function (t, e) {
            $(t, e, !1)
        ...
        ft = function (t) {
            if (function () {
                var t = y();
                t && (t.parentNode.removeChild(t), ct([document.documentElement, document.body], [z["no-backdrop"], z["toast-shown"], z["has-column"]]))
                ...
                n.appendChild(e),
                    ...
                    function () {
                        var t = P(),
                            ...
                            u = lt(t, z.textarea);
                        e.oninput = it, n.onchange = it, r.onchange = it, a.onchange = it, u.oninput = it, o.oninput = function (t) {
    ...
    function gt(t, e, n) {
        tt(t, n["showC" + e.substring(1) + "Button"], "inline-block"), t.innerHTML = n[e + "ButtonText"], t.setAttribute("aria-label", n[e + "ButtonAriaLabel"]), t.className = z[e], R(t, n.customClass, e + "Button"), st(t, n[e + "ButtonClass"])
    }
    ...
    function vt(t, e) {
        ...
        }(n, e.backdrop), !e.backdrop && e.allowOutsideClick && N('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), function (t, e) {
            e in z ? st(t, z[e]) : (N('The "position" parameter is not valid, defaulting to "center"'), st(t, z.center))
        }(n, e.position), function (t, e) {
            if (e && "string" == typeof e) {
                var n = "grow-" + e;
                n in z && st(t, z[n])
            }
        }(n, e.grow), R(n, e.customClass, "container"))
    }
    ...
    At.text = At.email = At.password = At.number = At.tel = At.url = function (t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : v(e.inputValue) || N('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), bt(t, e), t.type = e.input, t
    ...
    function St(t, i) {
        ...
        a >= i.progressSteps.length && N("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), i.progressSteps.forEach(function (t, e) {
            var n = function (t) {
    ...
    function Et(t, e) {
        var n = O();
        R(n, e.customClass, "header"), St(0, e),
            function (t, e) {
                ...
                if (n && e.icon === n.icon && k()) R(k(), e.customClass, "icon");
                    ...
                    if (-1 !== Object.keys(W).indexOf(e.icon)) {
                        ...
                        X(o), Ht(o, e), Mt(), R(o, e.customClass, "icon"), st(o, e.showClass.icon)
                    } else h('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"'))
            }(t, e),
            function (t, e) {
                var n = A();
                if (!e.imageUrl) return G(n);
                X(n), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt), J(n, "width", e.imageWidth), J(n, "height", e.imageHeight), n.className = z.image, R(n, e.customClass, "image")
            }(0, e),
            function (t, e) {
                var n = x();
                tt(n, e.title || e.titleText), e.title && rt(e.title, n), e.titleText && (n.innerText = e.titleText), R(n, e.customClass, "title")
            }(0, e),
            function (t, e) {
                var n = j();
                n.innerHTML = e.closeButtonHtml, R(n, e.customClass, "closeButton"), tt(n, e.showCloseButton), n.setAttribute("aria-label", e.closeButtonAriaLabel)
            }(0, e)
    }
    ...
    function Tt(t, e) {
        ! function (t, e) {
            var n = C();
            J(n, "width", e.width), J(n, "padding", e.padding), e.background && (n.style.background = e.background), n.className = z.popup, e.toast ? (st([document.documentElement, document.body], z["toast-shown"]), st(n, z.toast)) : st(n, z.modal), R(n, e.customClass, "popup"), "string" == typeof e.customClass && st(n, e.customClass)
        }(0, e), vt(0, e), Et(t, e), Bt(t, e), at(0, e),
            function (t, e) {
                var n = M();
                tt(n, e.footer), e.footer && rt(e.footer, n), R(n, e.customClass, "footer")
    ...
    function Vt() {
        ...
        var e = L(),
            n = E();
        X(e), X(n), st([t, e], z.loading), n.disabled = !0, t.setAttribute("data-loading", !0), t.setAttribute("aria-busy", !0), t.focus()
    }
    ...
    var Ut = [],
        ...
        zt = ["title", "titleText", "text", "html", "type", "customClass", "showConfirmButton", "showCancelButton", "confirmButtonText", "confirmButtonAriaLabel", "confirmButtonColor", "cancelButtonText", "cancelButtonAriaLabel", "cancelButtonColor", "buttonsStyling", "reverseButtons", "imageUrl", "imageWidth", "imageHeigth", "imageAlt", "progressSteps", "currentProgressStep"],
        Wt = {
    ...
    function Zt() {
        ...
        t.showConfirmButton || (G(e.confirmButton), t.showCancelButton || G(e.actions)), ct([e.popup, e.actions], z.loading), e.popup.removeAttribute("aria-busy"), e.popup.removeAttribute("data-loading"), e.confirmButton.disabled = !1, e.cancelButton.disabled = !1
    }
    ...
    function te(t, e, n, o) {
        ...
        }), Ft.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), I() && (null !== Y.previousBodyPadding && (document.body.style.paddingRight = Y.previousBodyPadding + "px", Y.previousBodyPadding = null), function () {
            if (q(document.body, z.iosfix)) {
                var t = parseInt(document.body.style.top, 10);
                ct(document.body, z.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * t
            }
        ...
        })), ct([document.documentElement, document.body], [z.shown, z["height-auto"], z["no-backdrop"], z["toast-shown"], z["toast-column"]])
    }
    ...
    function ee(t) {
        ...
        if (e) {
            ...
            if (n && !q(e, n.hideClass.popup)) {
                ...
                var i = y();
                ct(i, n.showClass.backdrop), st(i, n.hideClass.backdrop),
                    function (t, e, n) {
                        var o = y(),
                            i = ht && et(e),
                            r = n.onClose,
    ...
    function ce(t) {
        ...
        }(t), t.showLoaderOnConfirm && !t.preConfirm && N("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), t.animation = F(t.animation),
            function (t) {
                t.target && ("string" != typeof t.target || document.querySelector(t.target)) && ("string" == typeof t.target || t.target.appendChild) || (N('Target parameter is not valid, defaulting to "body"'), t.target = "body")
    ...
    var ye = function (t, e) {
        ...
        we = function (t, e) {
            ! function () {
                if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !q(document.body, z.iosfix)) {
                    ...
                    document.body.style.top = -1 * t + "px", st(document.body, z.iosfix), Xt()
                }
        ...
        Ce = function (t, e, n) {
            st(e, n.showClass.popup), st(t, n.showClass.backdrop), X(e), st([document.documentElement, document.body], z.shown), n.heightAuto && n.backdrop && !n.toast && st([document.documentElement, document.body], z["height-auto"])
        },
        ke = function (t) {
        ...
        Be = function (e, n) {
            ...
            G(o), n.inputValue.then(function (t) {
                o.value = "number" === n.input ? parseFloat(t) || 0 : t + "", X(o), o.focus(), e.hideLoading()
            }).catch(function (t) {
                h("Error in inputValue promise: " + t), o.value = "", X(o), o.focus(), e.hideLoading()
            })
        },
        Se = {
            ...
            radio: function (t, e, a) {
                ...
                e.forEach(function (t) {
                    ...
                    r.innerHTML = n, r.className = z.label, i.appendChild(o), i.appendChild(r), u.appendChild(i)
                });
    ...
    var Ke, Ye = Object.freeze({
        ...
        resetValidationMessage: function () {
            ...
            var e = this.getInput();
            e && (e.removeAttribute("aria-invalid"), e.removeAttribute("aria-describedBy"), ct(e, z.inputerror))
        },
        ...
        _main: function (t) {
            ! function (t) {
                for (var e in t) Dt(i = e) || N('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Kt.indexOf(o) && N('The parameter "'.concat(o, '" is incompatible with toasts'))), Nt(n = e) && g(n, Nt(n));
                var n, o, i
            ...
            ce(e), Object.freeze(e), Ft.timeout && (Ft.timeout.stop(), delete Ft.timeout), clearTimeout(Ft.restoreFocusTimeout);
            var n = function (t) {
                var e = {
                    popup: C(),
                    container: y(),
        ...
        update: function (e) {
            ...
            if (!t || q(t, n.hideClass.popup)) return N("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            var o = {};
            Object.keys(e).forEach(function (t) {
                Qe.isUpdatableParameter(t) ? o[t] = e[t] : N('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
            var i = u({}, n, o);
    ...
    }, u(Ze.prototype, Ye), u(Ze, Yt), Object.keys(Ye).forEach(function (e) {
        Ze[e] = function () {
            var t;
            if (Ke) return (t = Ke)[e].apply(t, arguments)
        }
    }), Ze.DismissReason = _, Ze.version = "9.3.1";
    var Qe = Ze;
